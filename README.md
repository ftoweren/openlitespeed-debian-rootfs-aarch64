...
- Openlitespeed-1.9.2 in latest version (with PHP 8.4.24 on :2026-08)
...
```
```bash
docker pull ftoweren/openlitespeed-debian-rootfs-aarch64:2026-08
```
```bash
...
_current/latest version: _admin/ln9yQlRFpVi7tC6I_
```bash
