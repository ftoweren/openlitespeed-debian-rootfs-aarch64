...
An ultra-lightweight, high-performance OpenLiteSpeed (1.8.4/1.9.2) Docker image built from scratch using a custom Debian Trixie mmdebstrap` rootfs. Optimized for ARM64 edge devices, Single Board Computers (SBCs), and low-resource environments.
- Openlitespeed-1.9.2 in latest version image (2026-08) with PHP 8.4.24 [update]
